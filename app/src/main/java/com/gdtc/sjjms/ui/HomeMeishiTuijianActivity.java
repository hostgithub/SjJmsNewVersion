...
public class HomeMeishiTuijianActivity extends BaseActivity {

    @BindView(R.id.tv_back)
    TextView tv_back;
    @BindView(R.id.photoview)//美食大图
    ImageView photoView;
    ...
    @BindView(R.id.seller_image)//商家小图
    ...
    private HomeTuijian.ResultsBean nearbySellerDetailBean;
    ...
    protected int getLayoutId() {
        return R.layout.activity_home_meishi_tuijian;
    }
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        nearbySellerDetailBean= (HomeTuijian.ResultsBean) intent.getSerializableExtra(Config.NEWS);


        if(nearbySellerDetailBean.getScore().equals("0")){
            iv_coll.setImageResource(R.mipmap.basecs_uncollect);
        }else {
            iv_coll.setImageResource(R.mipmap.basecs_collected);
        }
        Glide.with(HomeMeishiTuijianActivity.this).load(nearbySellerDetailBean.getGoodsImage()).into(photoView);
        Glide.with(HomeMeishiTuijianActivity.this).load(nearbySellerDetailBean.getBusinessTitleImage()).into(seller_image);
        ...
        type_star=nearbySellerDetailBean.getScore();
    ...
    private void initCommentListData(int pages,String id) {
        ...
        call.enqueue(new Callback<CommentList>() {
            ...
            public void onFailure(Call<CommentList> call, Throwable t) {
                Toast.makeText(HomeMeishiTuijianActivity.this,R.string.failure_tip,Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.tv_back:
                finish();
                HomeMeishiTuijianActivity.this.overridePendingTransition(0, R.anim.activity_close);
                break;
            case R.id.al_tuijian://点击进入推荐菜列表
                Intent intent=new Intent(HomeMeishiTuijianActivity.this,TuijianListActivity.class);
            ...
            case R.id.iv_coll://
                if(sp.getString(ConstantValue.WEIXIN_OPENID)!=null){
                    ...
                    startActivity(new Intent(HomeMeishiTuijianActivity.this, WeiXinActivity.class));
                }
                break;
...
//                showPopupWindow();
    ...
    private void getCollect(String businessId, String openId, String name, final String type) {
        ...
        call.enqueue(new Callback<Collect>() {
               ...
               if(response.body().getInformation().equals("1")){
                   runOnUiThread(new Runnable() {
                       ...
                       public void run() {
                           iv_coll.setImageResource(R.mipmap.basecs_collected);
                           type_star="1";
                           Toast.makeText(HomeMeishiTuijianActivity.this,"收藏成功",Toast.LENGTH_SHORT).show();
                       }
                   });
               }else {
                   runOnUiThread(new Runnable() {
                       ...
                       public void run() {
                           iv_coll.setImageResource(R.mipmap.basecs_uncollect);
                           type_star="0";
                           Toast.makeText(HomeMeishiTuijianActivity.this,"取消收藏",Toast.LENGTH_SHORT).show();
                       }
                   });
               }
            }
            ...
            public void onFailure(Call<Collect> call, Throwable t) {
                Toast.makeText(HomeMeishiTuijianActivity.this,"网络异常",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void showPopupWindow() {
        //设置contentView
        View contentView = LayoutInflater.from(HomeMeishiTuijianActivity.this).inflate(R.layout.popup_comment, null);
...
//                            "22222555555",editText.getText().toString().trim());
                    ...
                    Toast.makeText(HomeMeishiTuijianActivity.this,"评论内容不能为空",Toast.LENGTH_SHORT).show();
                }
            }
        });
        //是否具有获取焦点的能力
        ...
        call.enqueue(new Callback<Comment>() {
            ...
            public void onResponse(Call<Comment> call, Response<Comment> response) {
                if(response.body().getSuccess().equals("true")){
                    ...
                    Toast.makeText(HomeMeishiTuijianActivity.this,"评论成功",Toast.LENGTH_SHORT).show();
                }
            }
